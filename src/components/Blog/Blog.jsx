    ...
    <div className="w-1/2 mx-auto">
      ...
      <Card className="my-8">
        ...
        <p>
          ...
          will get two JSON strings: <br /> 1. The header and the payload.{" "}
          <br /> 2. The signature. <br /> The JOSE (JSON Object Signing and
          Encryption) header contains the type of token — JWT in this case — and
      ...
      <Card className="my-8">
        ...
        <Table>
          ...
          <Table.Body>
            <Table.Row>
              <Table.Cell>
                It is an accessible, bridge, parsed, lightweight, reactive, and
                web apps programming language.
              </Table.Cell>
              <Table.Cell>
                It's a bridge, open-source Js runtime environment for executing
                Js on the server.
              </Table.Cell>
            </Table.Row>
            <Table.Row>
            ...
            <Table.Row>
              ...
              <Table.Cell>
                It's made for real-time data-intensive apps that run on multiple
                platforms.
              </Table.Cell>
            </Table.Row>
          </Table.Body>
